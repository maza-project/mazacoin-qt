...
enum {
    ALGO_SLOT1 = 0,  // currently Lyra2RE2
    ALGO_SLOT2 = 1,  // currently Skein
    ALGO_SLOT3 = 2,  // currently Argon2d
    ALGO_SLOT4 = 3,  // currently SHA256
    NUM_ALGOS
};
...
enum
{
    ...
    // algo
    BLOCK_VERSION_ALGO      = (7 << 9), // currently Lyra2RE2
    BLOCK_VERSION_SLOT2     = (1 << 9), // currently Skein
    BLOCK_VERSION_SLOT3     = (2 << 9), // currently Argon2d
